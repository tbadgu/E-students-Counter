...
public class StudentPage extends JFrame{
	...
	public StudentPage(session obj)
	{
		session_obj=obj;
		setSize(550, 500);
		setLayout(null);
		...
		//add(notice);
		//notice.setBounds(200, 250, 100, 25);
	...
	class MouseHandler implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			case "hy1":
				...
				break;
			case "hy2":
				SFormSubmissionPage obj1=new SFormSubmissionPage(session_obj);
				break;
			case "hy3":
				break;
			case "hy4":
				new BonafidePage(session_obj);
				break;
			case "hy5":
				new UniversityFormSubmissionPage(session_obj);
				break;
			case "hy6":
				new EnquiryDesk(session_obj);
				break;
			case "hy7":
				new WifiPage(session_obj);
				break;
			case "hy8":
				new BonafidePage(session_obj);
				break;
